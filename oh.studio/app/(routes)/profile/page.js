	...
	return (
      ...
      <section className="py-40 text-center">
        <h1 className="text-center text-4xl leading-tight font-medium md:text-5xl lg:text-7xl">Hey 👋🏼 I'm Oli </h1>
			...
			<section className="flex gap-6 md:mx-6 lg:h-[32rem] lg:max-w-[84rem] lg:mx-auto">
				<Image
        ...
        />
			...
			<section className="text-center space-y-6 py-24 md:w-[35rem] md:mx-auto md:py-40 lg:w-[40rem]">
			...
			<section className="text-center space-y-4 md:py-16">
