			...
			<section className="text-center space-y-8	bg-secundary py-28">
				...
				<div className="flex items-center relative">
					<input type="search" placeholder="Search"
						className="w-full mx-4 max-w-[46rem] p-5 rounded-md outline-none border-[1px] text-xl border-black duration-300
						focus:border-contrast-primary placeholder:text-black"
					/>
					<ArrowRight width={40} className="absolute right-6"/>
				</div>
			</section>
			<section className="space-y-24 px-4 py-28">
				<article className="flex gap-2">
					<div className="flex-[20%] w-48">
					...
					<div className="flex-[80%] flex flex-col gap-2 ml-2">
						...
						<a href="#" className="flex items-center gap-2 text-contrast text-xl">Learn More <MoveRight width={24} strokeWidth={1} /></a>
					</div>
				</article>
				<article className="flex gap-2">
					<div className="flex-[20%] w-48">
